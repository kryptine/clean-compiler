...
*/
    ...
    # (ok, fun_defs, td_infos, main_dcl_module_n, predef_symbols, groups, hash_table, files, error, io, out, tcl_file, heaps)
        = if options.feo_tonic
            (execute_tonic mod_dir fun_defs td_infos main_dcl_module_n heaps predef_symbols list_comprehensions hash_table files icl_mod groups icl_used_module_numbers dcl_mods icl_qualified_imports icl_import list_inferred_types icl_common icl_function_indices tcl_file error io out)
...
execute_tonic mod_dir fun_defs td_infos main_dcl_module_n heaps predef_symbols list_comprehensions hash_table files icl_mod groups icl_used_module_numbers dcl_mods icl_qualified_imports icl_import list_inferred_types icl_common icl_function_indices tcl_file error io out
  ...
  # (fun_defs, predef_symbols, groups, hash_table, error, files, heaps) = ginTonic mod_dir main_dcl_module_n fun_defs fun_defs_cpy groups icl_mod dcl_mods common_defs_cpy list_comprehensions predef_symbols class_instances hash_table error files heaps
