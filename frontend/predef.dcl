...
PD_TypeOBJECT				:== 202
PD_GenericInfo				:== 203
PD_TGenericConsDescriptor 	:== 204
PD_TGenericRecordDescriptor :== 205
PD_TGenericFieldDescriptor 	:== 206
PD_TGenericTypeDefDescriptor :== 207
PD_TGenConsPrio				:== 208
PD_TGenConsAssoc			:== 209
PD_TGenType					:== 210

PD_TypeGenericDict 			:== 211
// Generics fields
PD_map_to					:== 212
PD_map_from					:== 213
// Generics expression
...
PD_ConsFIELD				:== 221
PD_ConsOBJECT				:== 222
PD_NoGenericInfo			:== 223
PD_GenericConsInfo			:== 224
PD_GenericRecordInfo		:== 225
PD_GenericFieldInfo			:== 226
PD_GenericTypeInfo			:== 227
PD_CGenericConsDescriptor 	:== 228
PD_CGenericRecordDescriptor	:== 229
PD_CGenericFieldDescriptor 	:== 230
PD_CGenericTypeDefDescriptor :== 231
PD_CGenConsNoPrio			:== 232
PD_CGenConsPrio				:== 233
PD_CGenConsAssocNone		:== 234
PD_CGenConsAssocLeft		:== 235
PD_CGenConsAssocRight		:== 236
PD_CGenTypeCons				:== 237
PD_CGenTypeVar				:== 238
PD_CGenTypeArrow			:== 239
PD_CGenTypeApp				:== 240
...
PD_FromThenToS				:== 261
PD_FromThenToTS				:== 262
PD_FromThenToSTS			:== 263
PD_FromThenToU				:== 264
PD_FromThenToUTS			:== 265
PD_FromThenToO				:== 266
...
PD_Dyn__to_TypeCodeConstructor	:== 276

PD_NrOfPredefSymbols		:== 277
