...
//			  {uki_kind_heap, uki_error} = unifyKinds tk KI_Const {uki_kind_heap = as_kind_heap, uki_error = as_error}
	...
	analTypes has_root_attr modules form_tvs (TST atvs {st_vars, st_args, st_result}) (conds, as=:{as_type_var_heap,as_kind_heap})
		...
		# (arg_kinds, arg_propss, conds_as)
				= anal_types st_args (conds, { as & as_type_var_heap = as_type_var_heap, as_kind_heap = as_kind_heap})
			with 
		...
		# (res_kind, res_props, (conds, as)) = analTypes has_root_attr modules form_tvs st_result conds_as
		# uki = {uki_kind_heap = as.as_kind_heap, uki_error = as.as_error}		
		...
		= (KI_Const, type_props, (conds, { as & as_error = uki.uki_error, as_kind_heap = uki.uki_kind_heap}))
	where
